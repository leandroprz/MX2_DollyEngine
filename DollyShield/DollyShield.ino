...
const char* const man_str[] PROGMEM   = { manual_menu_1, manual_menu_2, manual_menu_3 };

const char* const park_str[] PROGMEM   = { park_menu_1, park_menu_2 };

const char* const axis0_str[] PROGMEM = { axis_menu_1, axis_menu_10, axis_menu_11, axis_menu_2, axis_menu_4, axis_menu_5, axis_menu_12, axis_menu_6, axis_menu_7, axis_menu_8 };
const char* const axis1_str[] PROGMEM = { axis_menu_1, axis_menu_10, axis_menu_11, axis_menu_2, axis_menu_4, axis_menu_5, axis_menu_12, axis_menu_6, axis_menu_7, axis_menu_8 };
const char* const cam_str[] PROGMEM   = { camera_menu_1, camera_menu_2, camera_menu_3, camera_menu_4, camera_menu_5, camera_menu_6, camera_menu_7, camera_menu_8 };
const char* const set_str[] PROGMEM   = { set_menu_1, set_menu_2, set_menu_3, set_menu_4, set_menu_5, set_menu_6, set_menu_7, set_menu_8, set_menu_9, set_menu_10, set_menu_11, set_menu_12, set_menu_13, set_menu_14, set_menu_15, set_menu_16, set_menu_17, set_menu_18 };
const char* const scope_str[] PROGMEM = { scope_menu_1, scope_menu_2 };
const char* const reset_str[] PROGMEM = { reset_menu_1, reset_menu_2 };
